...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 rounded-tr-[15px] rounded-br-[15px] top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#272264] duration-300 ease-linear  lg:static lg:translate-x-0 ${
